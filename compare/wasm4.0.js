        ...
        if (!Module["useCache"]) {
            ...
            if (Module["wasmtype"] == "zip") {
                ...
                try {
                    ...
                    WebAssembly.compile(wasmdata).then(function (wam) {
                        WebAssembly.instantiate(wam, info).then(receiveInstantiatedSource);
                    });
                } catch (error) {}
            } else {
                try {
...
function craftInvokerFunction(humanName, argTypes, classType, cppInvokerFunc, cppTargetFunc) {
    ...
    var anonymous = function (throwBindingError, invoker, fn, runDestructors, retType, classParam, argType0, argType1, argType2, argType3, argType4, argType5, argType6, argType7, argType8, argType9) {
        ...
        return Module[makeLegalFunctionName(humanName)] = function (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
...
function __emval_get_method_caller(argCount, argTypes) {
    ...
    var anonymous = function (retType, argType0, argType1, argType2, argType3, argType4, argType5, argType6, argType7, argType8, argType9) {
        var parentargs = Array.from(arguments);
        return Module[makeLegalFunctionName("methodCaller_" + signatureName)] = function (handle, name, destructors, args) {
            var args = Array.from(arguments);
            var argsList = [];
            for (var i = 0; i < argCount - 1; ++i) {
                argsList.push("arg" + i);
